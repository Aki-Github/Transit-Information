...
interface GtfsStopTime { trip_id: string; departure_time: string; stop_id: string; stop_headsign: string; stop_sequence: string; }
  ...
  const specificCalendarMap: { [key: string]: string } = {
    "O_4108_01": "weekday",  // 平日
    "O_4108_02": "saturday", // 土曜
    "O_4108_03": "holiday",  // 休日
    "O_4108_11": "weekday",  // 平日
    "O_4108_12": "saturday", // 土曜
    "O_4108_13": "holiday",  // 休日
    "O_4108_21": "weekday",  // 平日
    "O_4108_22": "saturday", // 土曜
    "O_4108_23": "holiday",  // 休日
    "O_4108_31": "weekday",  // 平日
    "O_4108_32": "saturday", // 土曜
    "O_4108_33": "holiday",  // 休日
    "O_4110_01": "weekday",  // 平日
    "O_4110_02": "saturday", // 土曜
    "O_4110_03": "holiday",  // 休日
    "O_4110_11": "weekday",  // 平日
    "O_4110_12": "saturday", // 土曜
    "O_4110_13": "holiday",  // 休日
    "O_4110_21": "weekday",  // 平日
    "O_4110_22": "saturday", // 土曜
    "O_4110_23": "holiday",  // 休日
    "O_4110_31": "weekday",  // 平日
    "O_4110_32": "saturday", // 土曜
    "O_4110_33": "holiday",  // 休日
    "O_4111_01": "weekday",  // 平日
    "O_4111_02": "saturday", // 土曜
    "O_4111_03": "holiday",  // 休日
    "O_4111_11": "weekday",  // 平日
    "O_4111_12": "saturday", // 土曜
    "O_4111_13": "holiday",  // 休日
    "O_4111_21": "weekday",  // 平日
    "O_4111_22": "saturday", // 土曜
    "O_4111_23": "holiday",  // 休日
    "O_4111_31": "weekday",  // 平日
    "O_4111_32": "saturday", // 土曜
    "O_4111_33": "holiday",  // 休日
    "O_4112_01": "weekday",  // 平日
    "O_4112_02": "saturday", // 土曜
    "O_4112_03": "holiday",  // 休日
    "O_4112_11": "weekday",  // 平日
    "O_4112_12": "saturday", // 土曜
    "O_4112_13": "holiday",  // 休日
    "O_4112_21": "weekday",  // 平日
    "O_4112_22": "saturday", // 土曜
    "O_4112_23": "holiday",  // 休日
    "O_4112_31": "weekday",  // 平日
    "O_4112_32": "saturday", // 土曜
    "O_4112_33": "holiday",  // 休日
    "O_9991_11": "weekday",  // 平日
    "O_9991_12": "saturday", // 土曜
    "O_9991_13": "holiday",  // 休日
    "O_9991_21": "weekday",  // 平日
    "O_9991_22": "saturday", // 土曜
    "O_9991_23": "holiday",  // 休日
    "O_9991_31": "weekday",  // 平日
    "O_9991_32": "saturday", // 土曜
    "O_9991_33": "holiday",  // 休日
    "O_9992_11": "weekday",  // 平日
    "O_9992_12": "saturday", // 土曜
    "O_9992_13": "holiday",  // 休日
    "O_9992_21": "weekday",  // 平日
    "O_9992_22": "saturday", // 土曜
    "O_9992_23": "holiday",  // 休日
    "O_9992_31": "weekday",  // 平日
    "O_9992_32": "saturday", // 土曜
    "O_9992_33": "holiday",  // 休日
    "O_9993_11": "weekday",  // 平日
    "O_9993_12": "saturday", // 土曜
    "O_9993_13": "holiday",  // 休日
    "O_9993_21": "weekday",  // 平日
    "O_9993_22": "saturday", // 土曜
    "O_9993_23": "holiday",  // 休日
    "O_9993_31": "weekday",  // 平日
    "O_9993_32": "saturday", // 土曜
    "O_9993_33": "holiday",  // 休日
    "O_9994_11": "weekday",  // 平日
    "O_9994_12": "saturday", // 土曜
    "O_9994_13": "holiday",  // 休日
    "O_9994_21": "weekday",  // 平日
    "O_9994_22": "saturday", // 土曜
    "O_9994_23": "holiday",  // 休日
    "O_9994_31": "weekday",  // 平日
    "O_9994_32": "saturday", // 土曜
    "O_9994_33": "holiday",  // 休日
  };

export const useSyncKawasakiCityTimetables = () => {
  const [loading, setLoading] = useState(false);

  const syncTimetables = async (): Promise<{ success: boolean; count?: number; error?: string }> => {
    setLoading(true);
    try {
      // 1. 公共交通オープンデータ等から川崎市営バスのGTFS ZIPを取得 (またはローカルpublicから)
      ...
      // trip_id ごとに「最終目的地の停留所名(終点)」をあらかじめ調べておくMap
      ...
      for (const st of stopTimes) {
        ...
        // 川崎市営バス用の識別IDを組み立てる (事業者:バス停ID:運行パターン:カレンダー区分)
        const timetableId = `kawasakicity:Timetable:${st.trip_id}:${tripInfo.serviceId}`;

        // サービスIDから曜日を取得
        const type = specificCalendarMap[tripInfo.serviceId] || "other";
        ...
        if (!timetablesMap.has(timetableId)) {
          timetablesMap.set(timetableId, {
            ...
            busroute: `kawasakicity:Busroute:${tripInfo.routeId}`,
            busroute_pattern: `kawasakicity:BusroutePattern:${st.trip_id}`,
            calendar: type,
        ...
        timetableObjects.push({
          ...
          busstop_pole_owl_sameas: `kawasakicity:BusstopPole:${st.stop_id}`,
