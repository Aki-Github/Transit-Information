...
interface ToeiTrainData {
  ...
  "odpt:delay"?: number;
  "dc:date"?: string; // データ生成時刻 ("2026-05-25T16:26:30+09:00" など)
}

interface TrainDetailModalProps {
  train: ToeiTrainData | null;
  isOpen: boolean;
...
export const TrainDetailModal: FC<TrainDetailModalProps> = ({ train, isOpen, styles, onClose, getDestinationNameJa }) => {
            ...
            <DialogBody>
                ...
                <HStack justify="space-between" pt="1">
                    ...
                    <Text color="gray.400" fontSize="12px" fontFamily="mono">
                      {formatTime(currentTrain["dc:date"])}
                    </Text>
                </HStack>
                </VStack>
            </DialogBody>
