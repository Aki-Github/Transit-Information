...
interface StationBetweenRowProps {
  lineId: string; // 追加: 路線IDを受け取る
  upBetweenTrains: ToeiTrainData[];
  downBetweenTrains: ToeiTrainData[];
...
export const StationBetweenRow: FC<StationBetweenRowProps> = memo(({
  lineId,
  upBetweenTrains,
  downBetweenTrains,
  styles,
...
StationBetweenRow.displayName = "StationBetweenRow";