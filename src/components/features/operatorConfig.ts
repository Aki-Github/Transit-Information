...
export const OPERATORS_CONFIG: OperatorConfig[] = [
  { 
    ...
    railwayIds: [
      ...
      "odpt.Railway:JR-East.Utsunomiya",      // 宇東線（東北線）
  ...
  },
  {
    ...
    title: "🚃 小田急電鉄 運行情報",
    titleEn: "🚃 Odakyu Electric Railway",
    railwayIds: [
  ...
  { 
    ...
    title: "🚃 京成電鉄 運行情報",
    titleEn: "🚃 Keisei Electric Railway",
    railwayIds: [
