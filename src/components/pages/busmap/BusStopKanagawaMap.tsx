...
let DefaultIcon = L.icon({
    iconUrl: '/kkrn_icon_bus_4.png',
    shadowUrl: iconShadow,
    // iconSize: [25, 41],
    // iconAnchor: [12, 41]
    // 💡 画像が正方形に近い[1:1]の比率なので、縦横を揃えると綺麗に表示されます
    iconSize: [48, 48],       // アイコンの表示サイズ [横幅, 縦幅] (お好みで 32, 32 や 48, 48 に調整してください)
    
    // 💡 アイコンの「どの位置」を地図の緯度経度のピンポイントに合わせるかの設定
    // 画像の「下部中央」を基準点にするため、[横幅の半分, 縦幅のジャスト] に設定します
    iconAnchor: [40, 40],     // iconSizeが[40, 40]なら、その半分と底辺
    
    // ポップアップが開く位置の調整（必要に応じて）
    popupAnchor: [0, -40]     // アイコンの頭上あたりにポップアップが出るように設定
});
